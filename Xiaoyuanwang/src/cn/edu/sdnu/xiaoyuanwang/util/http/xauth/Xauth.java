package cn.edu.sdnu.xiaoyuanwang.util.http.xauth;
...
import cn.edu.sdnu.xiaoyuanwang.LoginActivity;
import cn.edu.sdnu.xiaoyuanwang.util.http.xauth.net.HttpFetcher;
import cn.edu.sdnu.xiaoyuanwang.util.http.xauth.net.XAuthRequestHeaderBuilder;
import cn.edu.sdnu.xiaoyuanwang.util.http.xauth.security.HMACSHA1Signer;
import cn.edu.sdnu.xiaoyuanwang.util.http.xauth.security.SignatureBaseBuilder;
import cn.edu.sdnu.xiaoyuanwang.util.http.xauth.util.Constants;
...
public class Xauth {
	...
	public static String doMethod(String url) {
		...
		Boolean status = TryRequestRemote(url,
				tokenSecret, parameters, resultBuffer);
		Log.d("test1", "7.调用http传递参数并返回结果status和result:" + resultBuffer.toString());
